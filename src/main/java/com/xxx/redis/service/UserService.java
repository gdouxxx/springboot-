...
import com.xxx.redis.bean.User;
import com.xxx.redis.mapper.UserDao;
...
public class UserService {
    ...
    public User findUserById(int id){
        ...
        if(hasKey){
            ...
            //写入缓存
            operations.set(key,user,20, TimeUnit.HOURS);
            return user;
        }
    }
    ...
    public int updateUser(User user) {
        ...
        if (result != 0) {
            ...
            if (userNew != null) {
                operations.set(key, userNew, 30, TimeUnit.HOURS);
            }
        }
        return result;
    }
